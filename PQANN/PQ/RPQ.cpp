...
std::vector<float> RPQ::calc_datapoint_residuals_unroll(const std::vector<float> &datapoint0, const std::vector<float> &datapoint1) {
    std::vector<float> residual(datapoint0.size());
    for (size_t i = 0; i < datapoint0.size(); i+=8) {
        residual[i] = datapoint0[i] - datapoint1[i];
        residual[i + 1] = datapoint0[i + 1] - datapoint1[i + 1];
        residual[i + 2] = datapoint0[i + 2] - datapoint1[i + 2];
        residual[i + 3] = datapoint0[i + 3] - datapoint1[i + 3];
        residual[i + 4] = datapoint0[i + 4] - datapoint1[i + 4];
        residual[i + 5] = datapoint0[i + 5] - datapoint1[i + 5];
        residual[i + 6] = datapoint0[i + 6] - datapoint1[i + 6];
        residual[i + 7] = datapoint0[i + 7] - datapoint1[i + 7];
    }
    return residual;
}
